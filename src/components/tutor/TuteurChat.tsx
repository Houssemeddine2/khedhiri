...
export default function TuteurChat({ prenom, sessions: initialSessions, initialMessages, initialSessionId }: TuteurChatProps) {
  ...
  const accueil = `Bonjour ${prenom} ! 😊 Je suis Nour, ta tutrice. Montre-moi ton cahier ou pose-moi une question sur tes devoirs !`
    ...
    <div className="flex flex-col h-[calc(100vh-4rem)]">
      ...
      <div className="bg-white border-b border-sand-warm px-4 py-3 flex items-center justify-between flex-shrink-0">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="font-fraunces font-bold text-ink">Nour</p>
            <p className="font-manrope text-xs text-ink-soft">Ta tutrice • Toujours là pour t&apos;aider</p>
          </div>
        </div>
        <button
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 space-y-3 bg-cream">
        ...
        {messages.length === 0 && (
          <div className="flex gap-2 justify-start">
            <div className="w-8 h-8 rounded-full bg-olive flex items-center justify-center text-white text-sm font-bold flex-shrink-0">N</div>
            <div className="max-w-[80%] rounded-2xl px-4 py-2.5 bg-white border border-sand-warm rounded-bl-sm">
              ...
              <p className="font-manrope text-xs text-ink-soft mt-1">Nour</p>
            </div>
          </div>
        )}
      ...
      <div className="bg-white border-t border-sand-warm px-3 py-2 flex-shrink-0">
        <div className="flex items-end gap-2">
          ...
          <textarea
            ...
            placeholder="Pose ta question à Nour…"
            rows={1}
